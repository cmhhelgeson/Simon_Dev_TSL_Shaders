 ...
 */
export const fbm = Fn( ( [ p, options = {} ]: [ Node<'vec3'>, FbmOptions? ] ) => {
 ...
 */
export const ridgedFbm = Fn( ( [ p, options = {} ]: [ Node<'vec3'>, FbmOptions? ] ) => {
 ...
 */
export const domainWarpedFbm = Fn( ( [ p, options = {} ]: [ Node<'vec3'>, DomainWarpedFbmOptions? ] ) => {
 ...
 * @example
 */
export const warpedFbmCoords = Fn( ( [ uv0, _time, options = {} ]: [ Node<'vec2'>, Node<'float'>, WarpedFbmCoordsOptions? ] ) => {
