 ...
 * signature and every parameter degrades to an untyped node. Trailing optional
 * elements mirror the JS defaults, so call sites may still omit them.
 */
type Vec2AndFloat = [ Node<'vec2'>, Node<'float'>? ];
 ...
 */
export const sdfCircle = Fn( ( [ position, radius ]: [ Node<'vec2'>, Node<'float'> ] ) => {
 ...
 */
export const sdBox2d = Fn( ( [ _uv, _size = float( 0.0 ) ]: Vec2AndFloat ) => {
 ...
 * @returns {number} The signed distance from the box surface.
 */
export const sdBox3d = Fn( ( [ p, b = vec3( 0 ) ]: [ Node<'vec3'>, Node<'vec3'>? ] ) => {
 ...
 */
export const sdDiamond = Fn( ( [ _uv, r = 0.0 ]: [ Node<'vec2'>, ( Node<'float'> | number )? ] ) => {
 ...
 */
export const sdHexagon = Fn( ( [ p, _r = float( 0.5 ) ]: Vec2AndFloat ) => {
 ...
 */
export const sdEquilateralTriangle = Fn( ( [ p, _r = float( 0.1 ) ]: Vec2AndFloat ) => {
 ...
 */
export const sdLine = Fn( ( [ p ]: [ Node<'float'> ] ) => {
 ...
 */
export const sdRing = Fn( ( [ _uv, s = float( 0.4 ) ]: Vec2AndFloat ) => {
 ...
 */
export const sdParallelogram = Fn( ( [ _p, options = {} ]: [ Node<'vec2'>, SdParallelogramOptions? ] ) => {
...
const ndot = Fn( ( [ a, b ]: [ Node<'vec2'>, Node<'vec2'> ] ) => {
 ...
 */
export const sdRhombus = Fn( ( [ _p, b = vec2( 0.4 ) ]: [ Node<'vec2'>, Node<'vec2'>? ] ) => {
 ...
 * @returns {number} The signed distance from the triangle surface.
 */
export const sdTriangle = Fn( ( [ _p, size = float( 0.4 ) ]: Vec2AndFloat ) => {
